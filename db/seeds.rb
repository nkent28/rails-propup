...
prop = Prop.new(name: 'Wedding Table', description: "Beautiful long wedding table for hire", price: 85, availability: 'Now', location: "3 Abbey Terrace, Llangollen", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 75, availability: 'Now', location: "31a, Bell St, Reigate", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 20, availability: 'Now', location: "Tregellast Barton Farm, St Keverne, Helston", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 30, availability: 'Now', location: "Higher Cholwell, Totnes", user: User.first )
...
prop = Prop.new(name: 'Large Tutankhamun Egyptian Mummy Prop', description: "Large Tutankhamun Egyptian Mummy Prop to hire. Perfect for any Egyptian themed event or party.", price: 150, availability: 'Now', location: "150 Darkes Lane, Potters Bar", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 30, availability: 'Now', location: "74 Lordship Lane, London", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 20, availability: 'Now', location: "69 St. Marychurch Street, London", user: User.first )
...
prop = Prop.new(name: 'Wedding Bouquet', description: "Beautiful wedding bouquet(fake) for hire", price: 20, availability: 'Now', location: "67 Renfrew Rd, Ipswich", user: User.first )
prop.photos.attach(io: file, filename: 'fake_bouquet.jpg', content_type: 'image/jpg')
prop.save!
